...
def is_divisible(m, n):
  return is_multiple(n, m)

def are_all_div_by2(num, lst):
  return are_every(
    curry2(is_divisible, num),
    lst)

print(are_all_div_by2(2, [2, 4, 8, 6])) # True
...
are_all_div_by_three = curry2(are_all_div_by, 3)
print(are_all_div_by_three([3, 6, 9]))

# 3. are_all_pairs_div
# použít: curry2, are_every a is_multiple
